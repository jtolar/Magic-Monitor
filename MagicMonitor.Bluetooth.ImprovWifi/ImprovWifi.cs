...
namespace MagicMonitor.Bluetooth.ImprovWifi
{
    public class Improv
    {
            ...
            switch (command)
            {
                case 1:  //  Send WiFi settings
                    ...
                    else
                    {
                        ...
                        string ssid = Encoding.UTF8.GetString(bssid, 0, bssid.Length);
                        string password = Encoding.UTF8.GetString(bpassword, 0, bpassword.Length);
        ...
        private Buffer SetupRpcResult()
        {
            ...
            byte[] resultBytes = Encoding.UTF8.GetBytes(_rpcResult);
