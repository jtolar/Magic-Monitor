...
using MagicMonitor.Sensors.Bmxx80.FilteringMode;
using MagicMonitor.Sensors.Bmxx80.PowerMode;
using MagicMonitor.Sensors.Bmxx80.Register;
using UnitsNet;

namespace MagicMonitor.Sensors.Bmxx80
{
    /// <summary>
    ...
    public abstract class Bmx280Base : Bmxx80Base
    {
        ...
        ///// </summary>
        ///// <param name="deviceId">The ID of the device.</param>
        ///// <param name="spiDevice">The <see cref="SpiBusConfiguration"/> to create with.</param>
        //protected Bmx280Base(byte deviceId, SpiDevice spiDevice)
        //    : base(deviceId, spiDevice)
        //{
        //}
