...
using MagicMonitor.Bluetooth.Sender.Services;
using nanoFramework.Device.Bluetooth;
using nanoFramework.Device.Bluetooth.GenericAttributeProfile;
using nanoFramework.Runtime.Native;

namespace MagicMonitor.Bluetooth.Sender
{
    public class BluetoothDataSender
    {
        public static Guid serviceUuid = new("A7EEDF2C-DA87-4CB5-A9C5-5151C78B0057");
        public static Guid readStaticCharUuid = new("A7EEDF2C-DA89-4CB5-A9C5-5151C78B0057");
        ...
        public static void Start(int deviceId)
        {
            ...
            DeviceInformationServiceService DifService = new(
                    "Southern Harmony",
                    "Model-1",
                    deviceId.ToString(), // no serial number
                    "v1.0",
