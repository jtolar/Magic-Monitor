...
namespace MagicMonitor.SimplePrimitives
{
    public class StretchImage
    {
        ...
        {
            Bitmap bmWaterfall = new Bitmap(Resource.GetBytes(Resource.BinaryResources.NanoFrameworkLogo),
                Bitmap.BitmapImageType.NanoCLRBitmap); //new Bitmap(Resource.ResourceManager., Bitmap.BitmapImageType.Jpeg);
