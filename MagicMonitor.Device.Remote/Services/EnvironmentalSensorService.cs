...
namespace MagicMonitor.Device.Remote.Services
{
    public class EnvironmentalSensorService
    {
        ...
        {
            Co2CharacteristicUuid = Utilities.CreateUuidFromShortCode(0x2BD0);
        ...
        public void UpdateValue(int sensorIndex, float value)
        {
            ...
            switch (si.sensorType)
            {
                ...
                case SensorType.Co2:
                    //CO2 in PPM
                    var ppm = new VolumeConcentration((double)value, VolumeConcentrationUnit.PartPerMillion);
                    writer.WriteDouble(ppm.Value);
                    updated = true;
                    break;
            }
